      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            onClick={selectedImageIndex !== null ? handleBackToModal : onClose}
          ...
          {selectedImageIndex !== null && (
            ...
            >
              ...
              <button
                ...
                className="absolute top-4 left-4 z-10 flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg transition-colors duration-300"
              >
              ...
              <button
                ...
                className="absolute left-4 top-1/2 -translate-y-1/2 z-10 p-4 bg-white/10 hover:bg-white/20 rounded-full transition-colors duration-300"
              >
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 z-10 p-4 bg-white/10 hover:bg-white/20 rounded-full transition-colors duration-300"
              >
