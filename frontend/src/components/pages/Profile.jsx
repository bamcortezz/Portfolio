            ...
            >
              ...
              <div className="text-gray-400 leading-relaxed space-y-6">
                <div>
                  ...
                  <p className="text-gray-400">Currently studying - AY: 2024 - 2025</p>
                  <p className="text-gray-400 italic">Bacolor, Pampanga</p>
                </div>

                <div>
                  <h3 className="text-white font-medium text-lg">Assumpta Technical High School</h3>
                  <p className="text-gray-400 mt-1">Science, Technology, Engineering, and Mathematics</p>
                  <p className="text-gray-400">Senior High School | Batch 2022</p>
                  <p className="text-gray-400 italic">Sta Monica, San Simon, Pampanga</p>
                </div>

                <div>
                  <h3 className="text-white font-medium text-lg">Assumpta Technical High School</h3>
                  <p className="text-gray-400 mt-1">Junior High School | Batch 2016</p>
                  <p className="text-gray-400 italic">Sta Monica, San Simon, Pampanga</p>
                </div>
              </div>
            </motion.div>
              ...
              <div className="text-gray-400 leading-relaxed space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="list-disc list-inside ml-2 space-y-1">
                    ...
                    <li>Installing and Configuring Computer Systems (January 2025)</li>
                    <li>Introduction to IoT and Digital Transformation (March 2025)</li>
                  </ul>
                </div>
              </div>
            </motion.div>
